...
function App() {
  ...
  useEffect(() => {
    async function fetchSensorData() {
      ...
      try {
        const response_Latest = await fetch('http://220.121.96.238:8000/api/latest');
        
        const response_Month = await fetch('http://220.121.96.238:8000/api/month', {
          method: 'POST',
          headers: {
        ...
        const response_Week = await fetch('http://220.121.96.238:8000/api/week', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        const response_Hour = await fetch('http://220.121.96.238:8000/api/hourly', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
      ...
      <div className="container">
        ...
        <div className="others">
          <Routes>
            ...
            <Route path="/history" element={<HomeHistory MonthData={MonthSensorData} HourData={HourSensorData}/>} />
          </Routes>
        </div>
      </div>
    </div>
